...
cv::Rect scaleSizeRect(cv::Rect rr, double sizeIncrease)
{
    rr.x=rr.x-sizeIncrease/2;
    rr.y=rr.y-sizeIncrease/2;
    rr.width=rr.width+sizeIncrease;
    rr.height=rr.height+sizeIncrease;
